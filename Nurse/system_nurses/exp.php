                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        ?>
                            ...
                            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="exp.php" aria-expanded="false"><i class="me-3 fa fa-building" aria-hidden="true" style="color:rgba(63,187,192,255) ;"></i><span class="hide-menu" style="color:rgba(63,187,192,255) ;">Experience</span></a>
                            </li>
                        ...
                        ?>
                            ...
                            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="booked_app.php" aria-expanded="false"><i class=" me-3  fa fa-check-double" aria-hidden="true"></i><span class="hide-menu">Booked Appointments</span></a></li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal form-material mx-2">
                                            ...
                                            <div class="form-group">
                                                <input type="text" placeholder="to date" value="To: <?php echo $row['to_date']; ?>" class="form-control ps-0 form-control-line" disabled>
                                            </div>
                                            <div class="form-group">
