                ...
                <div class="navbar-collapse collapse" style="background-color:rgba(63,187,192,255) ;" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav me-auto mt-md-0 ">
                        ...
                        <li class="nav-item hidden-sm-down">
                             ...
                             <span
                                    class="hide-menu" style="color:white;font-size: 20px; padding-left: 30px;">Location</span></a>
                        </li>
                    </ul>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" >
                       ...
                       <!--  <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="location.php" aria-expanded="false" style="color:rgba(63,187,192,255) ;"><i class="me-3 fa fa-globe" style="color:rgba(63,187,192,255) ;"
