            ...
            <h6>
                <table align="center" cellpadding="10" cellspacing="10" bgcolor="White">
                    ...
                    <tr>
                        ...
                        <td><input type="email" name="user_ph" value="<?php echo $row_user['ph_no']; ?>" style="width:600px;border-color:lightgrey;padding:5px;border-radius:5px;" id="NurseName" readonly /></td>
                    </tr>
