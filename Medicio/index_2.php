    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" data-bs-toggle="modal" data-bs-target="#signup" href="#">Sign up</a></li>

          <!-- <button type="button" class="btn btn-primary"  style="background-color:#3fbbc0; color:white;padding:10px;">
            Sign up
          </button> -->
      ...
      <a  class="appointment-btn scrollto" data-bs-toggle="modal" data-bs-target="#exampleModal1"><span class="d-none d-md-inline">Make an</span> Appointment</a>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <a href="patient/signUp/email.php"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">sign up as user</button></a>
  ...
  <div class="modal fade" id="login" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
          <a href="patient/login/login.php"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">login as user</button></a>
