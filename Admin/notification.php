...
<body>
    <div class="fluid-container">
        ...
        <div class="fluid-container border border-3 border-secondary d-flex flex-row p-1">
            <i class="fa fa-2x fa-user user ms-3 "></i>
            ...
            <div class="end d-flex position-absolute end-0 me-3">
                <button type="button" class="btn color  mx-2" id="openReq">Open</button>
                <button type="button" class="btn btn-danger mx-2" id="rejectReq"> 
