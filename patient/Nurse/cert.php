                       ...
                       // if (isset($_SESSION['admin_profile']) && isset($_REQUEST['status'])){
                        ?>
                           <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"  href="profile.php" aria-expanded="false">
                            ...
                            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="cert.php" aria-expanded="false" style="color:rgba(63,187,192,255) ;"><i style="color:rgba(63,187,192,255) ;" class="me-3 fa fa-certificate" aria-hidden="true"></i><span class="hide-menu">Certificates</span></a>
                            </li>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal form-material mx-2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php echo $row['course'];  ?>">
                                                <a href="../../Nurse/Nurse_signup/<?php echo $row['certificate']; ?>" target="_blank" class="link">
